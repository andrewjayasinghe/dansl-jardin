    ...
    render() {
        return (
            ...
            <ReactBootStrap.Row>
                    ...
                    <ReactBootStrap.Col><a href="/order4"><img src={pic1} className="pic"/><p>Classic</p></a></ReactBootStrap.Col>
                    </div>
                    <div className="bg-display-test">
                    <ReactBootStrap.Col><a href="/order4"><img src={pic2} className="pic"/><p style={{fontSize:'19px'}}>Popular Music</p></a></ReactBootStrap.Col>
                    </div>
                    <div className="bg-display-test">
